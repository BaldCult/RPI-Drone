        ...
        if event.type == ecodes.EV_ABS:
            if event.code == ecodes.ABS_X:
                ...
                if (((1000*event.value)/65535)+1000) in range(0,65535):
                    pi.set_servo_pulsewidth(ESC_GPIO1, -1*(((1000*event.value)/66000)+1000))
                    pi.set_servo_pulsewidth(ESC_GPIO2, -1*(((1000*event.value)/66000)+1000))
                    pi.set_servo_pulsewidth(ESC_GPIO3, -1*(((1000*event.value)/66000)+1000))
                    pi.set_servo_pulsewidth(ESC_GPIO4, -1*(((1000*event.value)/66000)+1000))
